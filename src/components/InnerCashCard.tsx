...
const InnerCashCard:React.FC<Props>=(props) => {
    return(
        ...
        <div className="md:flex">
            ...
            <div className="flex py-3 md:py-6 w-full md:w-5/12">
                <img className="w-28" src={props.img2}/>
                <div className="ml-4">
                    <h3 className="font-semibold">{props.head3}</h3>
                    <p className="mt-3 text-sm">{props.head4}</p>
                </div>
            </div>
        </div>
    </div>
...
InnerCashCard.defaultProps={
    
}
export default InnerCashCard;